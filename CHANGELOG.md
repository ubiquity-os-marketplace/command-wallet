...
* schema validation ([1087646](https://github.com/ubiquity-os-marketplace/command-wallet/commit/1087646b2288b958b2891e533a1064182b1d6d8c))
...
* used ubiquity-os-logger for logging ([142b6e6](https://github.com/ubiquity-os-marketplace/command-wallet/commit/142b6e617dd71554a30883e1653f64e5011ca651))
...
* used ubiquity's knip-reporter ([fc478d6](https://github.com/ubiquity-os-marketplace/command-wallet/commit/fc478d6bd809bfd41ef5ccd636d786cef09e71a2))
* used ubiquity's knip-reporter ([a5829ff](https://github.com/ubiquity-os-marketplace/command-wallet/commit/a5829ff180f33834a967b193ceed5647c3e65294))
...
* add json import attributes for deno ([b5648b1](https://github.com/ubiquity-os-marketplace/command-wallet/commit/b5648b11c17d6b551251e6080ca85ce2815fdb65))
...
* address non-transitive CI failures ([c4caecc](https://github.com/ubiquity-os-marketplace/command-wallet/commit/c4caeccd2db46ef95ae3c45ec0a3d2a0e8b10303))
...
* align deno worker env handling ([3a15ec4](https://github.com/ubiquity-os-marketplace/command-wallet/commit/3a15ec49f39ffd39460587b781e96448595de661))
...
* avoid plugin-sdk runtime imports in tests ([4ace210](https://github.com/ubiquity-os-marketplace/command-wallet/commit/4ace210c52ca3b80a7bb07461162952e06232deb))
...
* bump plugin-sdk for runtime manifest refs ([0ae8aab](https://github.com/ubiquity-os-marketplace/command-wallet/commit/0ae8aabba742d5436140d9920774a2c52f097c10))
...
* **ci:** align deploy workflows with artifact defaults ([9f85b76](https://github.com/ubiquity-os-marketplace/command-wallet/commit/9f85b76fdd6a02d471b80d31eb7e4930ab09641b))
* **ci:** setup deno before install-time manifest generation ([fa22bc0](https://github.com/ubiquity-os-marketplace/command-wallet/commit/fa22bc07bf74491cf9e35094cbc3f187d99a80ea))
* **ci:** treat demo as production secrets environment ([1fc636b](https://github.com/ubiquity-os-marketplace/command-wallet/commit/1fc636ba877d749d7fbdb4be23f15d2d6a64ecaf))
* **ci:** use artifact branch deploy actions ([41a4920](https://github.com/ubiquity-os-marketplace/command-wallet/commit/41a492010ff2ba15ac1fe0e730e4dafadcd020c1))
* **config:** add descriptions to JSON schema properties ([0bae3bb](https://github.com/ubiquity-os-marketplace/command-wallet/commit/0bae3bbc7179bf444224ea9264318ec8b528072f))
...
* deployment url ([37a557c](https://github.com/ubiquity-os-marketplace/command-wallet/commit/37a557c7b1107787087ad00255ed945e5767a415))
* error messages ([bfd38c3](https://github.com/ubiquity-os-marketplace/command-wallet/commit/bfd38c31a30df6f62e6b49c33069fa40b42a87ab))
...
* formatting ([b5b45fc](https://github.com/ubiquity-os-marketplace/command-wallet/commit/b5b45fc6c2914059b965973f6513e679cdef60e1))
...
* generate manifest on install for tests and deploy ([dd91b84](https://github.com/ubiquity-os-marketplace/command-wallet/commit/dd91b84e12476fbaa9788021a04a5b1417ec6651))
...
* inline manifest prepare and target deploy action main ([2edc1bb](https://github.com/ubiquity-os-marketplace/command-wallet/commit/2edc1bb11a2dac10fd700f704539bd0bcd3a4e49))
* install dependencies before deno deploy ([f9b5921](https://github.com/ubiquity-os-marketplace/command-wallet/commit/f9b59219e3f3f98201c21aabe794fc62e5c324f7))
...
* **knip:** use bunx for manifest prepare script ([0e5384b](https://github.com/ubiquity-os-marketplace/command-wallet/commit/0e5384ba592eafa469e1709c9cb78c861710b1b8))
...
* **manifest:** derive short_name from CI repository context ([87df20c](https://github.com/ubiquity-os-marketplace/command-wallet/commit/87df20c0bf65bcb48d0a442957b50ef42f95d7d4))
* post message from sdk ([03646cf](https://github.com/ubiquity-os-marketplace/command-wallet/commit/03646cf1b869095637cd1b77dd69ee05dfd5690e))
* **prepare:** use published manifest tool dist-tag ([cffcb53](https://github.com/ubiquity-os-marketplace/command-wallet/commit/cffcb536e91b38dd76301bf48b81ce1f885e186c))
...
* restore workflow environments ([8885235](https://github.com/ubiquity-os-marketplace/command-wallet/commit/8885235f66ab333295898cfef69faf5cc763cf4c))
...
* set deploy action ref to [@main](https://github.com/main) ([3858e29](https://github.com/ubiquity-os-marketplace/command-wallet/commit/3858e29be3908633ecd84bf6381ae051f284de24))
...
* tests, formatting, delete bun.lockb ([2abba30](https://github.com/ubiquity-os-marketplace/command-wallet/commit/2abba30e02e6dc22c10c5f961cca9263fe60377c))
...
* update JSON import syntax ([06a008f](https://github.com/ubiquity-os-marketplace/command-wallet/commit/06a008fe008c24b46a9cdb468ba3c98db8021021))
* update JSON import syntax in command-parser handler ([ded7d8f](https://github.com/ubiquity-os-marketplace/command-wallet/commit/ded7d8f63c2ddbd35e55fc150e31c203ab584f5a))
* update JSON import syntax in worker module ([1975c7b](https://github.com/ubiquity-os-marketplace/command-wallet/commit/1975c7bb3164b7c7fb89282676ba837a0caec94d))
...
* update wrangler.toml ([6118ad6](https://github.com/ubiquity-os-marketplace/command-wallet/commit/6118ad6d0c70229f18804c98ed46231a305722fa))
...
* upgrade plugin sdk runtime manifest support ([d7e091c](https://github.com/ubiquity-os-marketplace/command-wallet/commit/d7e091cbd104f7ca3d1f138be533e503eec0bd1c))
...
* wallet not being set (user is not created) ([a0dde2c](https://github.com/ubiquity-os-marketplace/command-wallet/commit/a0dde2c994e427fed5b341797b3c6418b6e40947))
...
* widen runtime env typing ([d2fcceb](https://github.com/ubiquity-os-marketplace/command-wallet/commit/d2fccebd1da60bfe822ae0454037312c821e3f90))
* **workflows:** pin deploy action ref and source branch input ([92a68f9](https://github.com/ubiquity-os-marketplace/command-wallet/commit/92a68f96db71be2c71edc991dc80e501d8cca890))
* **workflows:** use artifact deploy action branch for dist publish ([68bdfef](https://github.com/ubiquity-os-marketplace/command-wallet/commit/68bdfeffade2f31bc10b3f6944cf4b4982299e94))
